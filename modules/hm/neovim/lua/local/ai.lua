...
local setupChatGpt = function()
    local config = {
        ...
        chat_dir = vim.fn.stdpath("cache") .. "/scratch.nvim",
        ...
        chat_shortcut_respond = { modes = { "n", "i", "v", "x" }, shortcut = "<leader>cr" },
    ...
    --     callback = function()
    --         require("gp").setup({ openai_api_key = "UNSET" })
    --     end,
    -- })
    --
    --[[ vim.api.nvim_create_autocmd({ 'BufEnter' }, {
